        ...
        <div className="flex-none">
          ...
          <div className="dropdown-end dropdown">
            <label tabIndex={0} className="btn-ghost rounded-btn btn gap-3">
              ...
              <HiOutlineChevronDown className="hidden lg:inline" />
            </label>

            <div className="dropdown-content max-h-80 overflow-y-auto rounded-xl bg-base-200">
          ...
          <button className="btn-ghost btn-square btn text-3xl lg:hidden">
            <HiOutlineMenuAlt3 />
          </button>
        </div>
      </div>
